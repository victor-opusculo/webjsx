...
declare global {
  namespace JSX {
    ...
    export type TargetedInputEvent<Target extends EventTarget> = TargetedEvent<
      ...
      InputEvent
    >;
    export type TargetedSecurityPolicyViolationEvent<
      Target extends EventTarget
    > = TargetedEvent<Target, SecurityPolicyViolationEvent>;
    ...
    >;
    export type SecurityPolicyViolationEventHandler<
      Target extends EventTarget
    > = EventHandler<TargetedSecurityPolicyViolationEvent<Target>>;
